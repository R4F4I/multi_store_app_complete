...
class HaveAccount extends StatelessWidget {
  ...
  final Function() onPressed;
  const HaveAccount({
    super.key, required this.actionLabel, required this.haveAccount, required this.onPressed
  });
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
         Text(headerLabel,style: const TextStyle(fontSize: 40,fontWeight: FontWeight.bold),),
        IconButton(
          onPressed: (){
